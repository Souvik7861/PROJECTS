...
job_flow_overrides = {
    "Name": "pyspark_emr_airflow_cluster",
    "ReleaseLabel": "emr-7.0.0",
    "Applications": [{"Name": "Spark"}, {"Name": "JupyterEnterpriseGateway"},{"Name": "Livy"},{"Name": "Hadoop"},{"Name": "Hive"}],
    "LogUri": "s3://pyspark-emr-airflow-yml/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-09c0da823b784501d",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["s3://pyspark-emr-airflow-yml/scripts/ingest.sh",] ,
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit", "s3://pyspark-emr-airflow-yml/scripts/transform_redfin_data.py", ] ,
        },
    },
   ]
...
with DAG('pyspark-emr-airflow_dag',
