...
from ingest import load_files, df_count
...
def main():
    ...
    try:
        ...
        logging.info("reading file df_city : {:.2f} seconds".format(perf_counter() - start_time))
        ...
        logging.info("displaying file df_city : {:.2f} seconds".format(perf_counter() - start_time))
        ...
        logging.info("reading file df_fact : {:.2f} seconds".format(perf_counter() - start_time))

        logging.info('displaying the df_fact dataframe')
        df_fact.show()

        logging.info("displaying file df_fact : {:.2f} seconds".format(perf_counter() - start_time))
        ...
        logging.info("implementing data_processing methods (data_clean) : {:.2f} seconds".format(perf_counter() - start_time))          ##############
        ...
        logging.info(" check_for_nulls : {:.2f} seconds".format(perf_counter() - start_time))               ############
        ...
        logging.info("displaying the df_report_1 : {:.2f} seconds".format(perf_counter() - start_time))
        ...
        logging.info("Displaying data_report2 : {:.2f} seconds".format(perf_counter() - start_time))
        ...
        logging.info("extracting files to output : {:.2f} seconds".format(perf_counter() - start_time))
